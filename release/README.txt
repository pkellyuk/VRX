VRX 1.0.0 - Windows x64

Install with VRX-Setup-1.0.0.exe, or extract the complete portable ZIP and run
...
the active OpenXR runtime in its settings. Hardware tested: RTX 3090 and PSVR2.
